...
public class sportCheck2 extends Activity {
 ...
 button1=(ImageView)findViewById(R.id.backsport2);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
			    ...
			    intent.setClass(sportCheck2.this,sportcheck.class);
			    startActivity(intent);
			    sportCheck2.this.finish();
			}
		});
    }
