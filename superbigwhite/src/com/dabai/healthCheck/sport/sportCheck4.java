...
public class sportCheck4 extends Activity {
...
button1=(ImageView)findViewById(R.id.backsport4);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
			    ...
			    intent.setClass(sportCheck4.this,sportcheck.class);
			    startActivity(intent);
			    sportCheck4.this.finish();
			}
		});
    }
